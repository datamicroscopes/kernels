...
test: build_py
	...
	PYTHONPATH=$$PYTHONPATH:$(MICROSCOPES_COMMON_REPO):$(MICROSCOPES_MIXTUREMODEL_REPO):$(MICROSCOPES_IRM_REPO):. nosetests --verbose

.PHONY: fast_test
fast_test: build_py
	$(LIBPATH_VARNAME)=$$$(LIBPATH_VARNAME):$(MICROSCOPES_COMMON_REPO)/out:$(MICROSCOPES_MIXTUREMODEL_REPO)/out:$(MICROSCOPES_IRM_REPO)/out:./out \
	PYTHONPATH=$$PYTHONPATH:$(MICROSCOPES_COMMON_REPO):$(MICROSCOPES_MIXTUREMODEL_REPO):$(MICROSCOPES_IRM_REPO):. nosetests --verbose -a '!slow'
